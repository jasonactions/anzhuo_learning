...
public class CameraInfotainmentAppsTogglePreferenceController
    ...
    private static final String TAG = "CameraRequiredApps";
    @Override
    protected boolean handlePreferenceChanged(CarUiSwitchPreference preference,
        ...
        if (isChecked == isCameraMutedForInfotainmentApps()) {
            ...
            Log.e(TAG, "handlePreferenceChanged isChecked=" + isChecked
                    + " newState=" + newState
                    + " mHasCameraPrivacyAllowlist=" + mHasCameraPrivacyAllowlist);
